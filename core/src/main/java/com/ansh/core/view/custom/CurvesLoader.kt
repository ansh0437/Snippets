package com.ansh.core.view.custom
...
import com.ansh.core.interfaces.LoaderContract
import java.util.*
...
class CurvesLoader : LinearLayout, LoaderContract {
    ...
    constructor(
        context: Context,
        noOfCurves: Int,
        outermostCurveRadius: Int,
        curveWidth: Int,
        distanceBetweenCurves: Int,
        curveSweepAngle: Float,
        curveColor: Int
    ) : super(context) {
    ...
    override fun initAttributes(attrs: AttributeSet) {
        ...
        this.outermostCurveRadius = typedArray.getDimensionPixelSize(
            R.styleable.CurvesLoader_curves_outermostCurveRadius,
            100
        )

        this.curveWidth =
            typedArray.getDimensionPixelSize(R.styleable.CurvesLoader_curves_curveWidth, 10)
        this.distanceBetweenCurves = typedArray.getDimensionPixelSize(
            R.styleable.CurvesLoader_curves_distanceBetweenCurves,
            10
        )

        this.curveSweepAngle =
            typedArray.getFloat(R.styleable.CurvesLoader_curves_curveSweepAngle, 160.0f)

        this.curveColor = typedArray.getColor(
            R.styleable.CurvesLoader_curves_curveColor,
        ...
        this.interpolator = AnimationUtils.loadInterpolator(
            ...
            typedArray.getResourceId(
                R.styleable.CurvesLoader_curves_interpolator,
    ...
    private fun initView() {
        ...
        for (i in 0 until noOfCurves) {
            ...
            val arcView = ArcView(
                context, circleRadius, curveWidth, startAngle,
                curveSweepAngle, curveColor, true
            )
